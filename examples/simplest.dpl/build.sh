...
g++ -Wall --std=c++17 -I${IXWS_HOME} -I${KVAN_HOME}/cpp/include -c dipole.cpp
g++ -Wall --std=c++17 -I${IXWS_HOME} -I${KVAN_HOME}/cpp/include -c HelloI.cpp
g++ -Wall --std=c++17 -o server.tsk main.o dipole.o HelloI.o -L${KVAN_HOME}/cpp/src -lKVAN -L${YAJL_HOME}/lib -lyajl -L${IXWS_HOME}/build -lixwebsocket -pthread -lz -lssl -lcrypto -lstdc++fs -lyaml
