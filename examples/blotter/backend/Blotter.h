...
namespace Blotter {
  ...
  public:
    ...
    DFWUPC get_df();
    void subscribe(ObserverPtr ptr);
  };
}
...
namespace Blotter {
  ...
  public:
    ...
    virtual DFWUPC get_df() = 0;
    virtual void subscribe(ObserverPtr ptr) = 0;
  };
...
namespace Blotter {
  ...
  inline DFWUPC DFTestPtr::get_df()
  {
  ...
  inline void DFTestPtr::subscribe(ObserverPtr ptr)
  {    
    ...
    cout << "subscribe response: " << res_s.second << endl;
  ...
  inline void ObserverPtr::show(DFWUPC df)
  {    
    ...
    ostringstream json_os;
    to_json(json_os, req);
    //cout << "Observer::show: " << json_os.str() << endl;
    pybx::ws_send(ws, json_os.str());
    auto res_s = comm->wait_for_response(req.message_id);
    comm->check_response(res_s.first, res_s.second);
